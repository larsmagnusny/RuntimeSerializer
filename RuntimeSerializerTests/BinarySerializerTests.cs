...
namespace RuntimeSerializer.Tests
{
    ...
    public class BinarySerializerTests
    {
        ...
        public void Serialize_Deserialize_Test()
        {
            ...
            Assert.AreEqual(t1.Value14, t2.Value14);
        }
        ...
        [TestMethod()]
        public void Serialize_Deserialize_Nullables_Test()
        {
            var outStream = new MemoryStream();
            ...
            var t2 = BinarySerializer.DeSerialize<TestClass2>(outStream);
        ...
        public void Serialize_Array_Test()
        {
            ...
            for(var i = 0; i < t1.Length; i++)
            {
                ...
                Assert.AreEqual(t1[i].Value14, t2[i].Value14);
            }
        }

        [TestMethod()]
        public void Serialize_Nested_Array_Test()
        {
            var outStream = new MemoryStream();
            ...
            var t1 = new TestClass3() {
                ...
                Value13 = DateTimeOffset.UtcNow,
                Value14 = Guid.NewGuid(),
                Array = new TestClass1[1000] 
            };

            for (var i = 0; i < t1.Array.Length; i++)
            {
                t1.Array[i] = new TestClass1()
                {
                    Value0 = 254,
                    Value1 = -1,
                    Value2 = 'a',
            ...
            var t2 = BinarySerializer.DeSerialize<TestClass3>(outStream);

            Assert.AreEqual(t1.Array.Length, t2.Array.Length);

            for (var i = 0; i < t1.Array.Length; i++)
            {
                Assert.AreEqual(t1.Array[i].Value0, t2.Array[i].Value0);
                Assert.AreEqual(t1.Array[i].Value1, t2.Array[i].Value1);
                Assert.AreEqual(t1.Array[i].Value2, t2.Array[i].Value2);
                Assert.AreEqual(t1.Array[i].Value3, t2.Array[i].Value3);
                Assert.AreEqual(t1.Array[i].Value4, t2.Array[i].Value4);
                Assert.AreEqual(t1.Array[i].Value5, t2.Array[i].Value5);
                Assert.AreEqual(t1.Array[i].Value6, t2.Array[i].Value6);
                Assert.AreEqual(t1.Array[i].Value7, t2.Array[i].Value7);
                Assert.AreEqual(t1.Array[i].Value8, t2.Array[i].Value8);
                Assert.AreEqual(t1.Array[i].Value9, t2.Array[i].Value9);
                Assert.AreEqual(t1.Array[i].Value10, t2.Array[i].Value10);
                Assert.AreEqual(t1.Array[i].Value11, t2.Array[i].Value11);
                Assert.AreEqual(t1.Array[i].Value12, t2.Array[i].Value12);
                Assert.AreEqual(t1.Array[i].Value13, t2.Array[i].Value13);
                Assert.AreEqual(t1.Array[i].Value14, t2.Array[i].Value14);
            }
        }
    }
}